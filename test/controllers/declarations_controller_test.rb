...
class DeclarationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create declaration" do
    assert_difference("Declaration.count") do
      post declarations_url, params: { declaration: { doctor_id: @declaration.doctor_id, patient_id: @declaration.patient_id, start_date: @declaration.start_date } }
    end
  ...
  test "should update declaration" do
    patch declaration_url(@declaration), params: { declaration: { doctor_id: @declaration.doctor_id, patient_id: @declaration.patient_id, start_date: @declaration.start_date } }
